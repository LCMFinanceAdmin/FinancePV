...
import {
  ...
  CalendarDays, TrendingUp, Inbox, Landmark,
} from "lucide-react";
  ...
  const moreSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/recurring?type=bam", label: "BAM Recurring",      icon: <RefreshCw size={16} />, show: user.isBuildingManager || user.isFinanceAdmin },
      ],
    },
    {
      label: "Budget",
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/banking",           label: "Banking",           icon: <Landmark size={16} />,     show: user.isFinanceAdmin || user.isGeneralManager },
      ],
    },
    {
